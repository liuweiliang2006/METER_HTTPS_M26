...
//							IsSaveREAL_DATA_Credit = true;//充值
				...
				else if(strstr(buffer,"CYCH")!=NULL)
        {
					...
					while(currPosition<buffer+sum)
					{
						...
						{
							case 0:
								strncpy(ReplyPacket.keyWord,StrSetbuf,4);
								break;
							case 1:
								strncpy(ReplyPacket.meterNumer,StrSetbuf,10);
								break;
							case 2:
								strncpy(ReplyPacket.identifier,StrSetbuf,4);
								break;
							case 3:
								break;
							case 4:
							...
							case 7:
							  ...
							  //printf("REAL_DATA_Credit.LPGDensity : %f",REAL_DATA_Credit.LPGDensity);
								break;
							case 8:
								strncpy(ReplyPacket.datetime,StrSetbuf,12);
								sscanf(ReplyPacket.datetime+2,"%6ld",&yymmdd);
								sscanf(ReplyPacket.datetime+8,"%4ld",&hhmmss);
								//SetRTC(hhmmss * 100,yymmdd);
								NextIsEnd = true;
								break;
							case 9:
								strncpy(ReplyPacket.verification,StrSetbuf,strlen(StrSetbuf));
								break;
						}
						elementIndex++;
					}
				...
				else if(strstr(buffer,"IPCH")!=NULL)
        {
					currPosition = buffer + 2;
					while(currPosition<buffer+sum)
					{
						...
						switch(elementIndex)
						{
							...
							case 2:
								...
								break;
							case 3:
								memset(CONFIG_GPRS.Server_IP,0,sizeof(CONFIG_GPRS.Server_IP));
								strncpy(CONFIG_GPRS.Server_IP,StrSetbuf,strlen(StrSetbuf));
							  //printf("Server_IP %s\r\n",CONFIG_GPRS.Server_IP);
								break;
							case 4:
								memset(CONFIG_GPRS.Socket_Port,0,sizeof(CONFIG_GPRS.Socket_Port));
								strncpy(CONFIG_GPRS.Socket_Port,StrSetbuf,strlen(StrSetbuf));
							  //printf("Socket_Port %s\r\n",CONFIG_GPRS.Socket_Port);
								break;
							case 5:
								strncpy(ReplyPacket.datetime,StrSetbuf,12);
								sscanf(ReplyPacket.datetime+2,"%6ld",&yymmdd);
		        ...
		        //printf("StrSetbuf %s\r\n",StrSetbuf);
						switch(elementIndex)
						{
							...
							case 5:
								...
								break;
							case 6:
								strncpy(CustomerCredit.verification,StrSetbuf,strlen(StrSetbuf));
								break;
						}
						elementIndex++;
					}
